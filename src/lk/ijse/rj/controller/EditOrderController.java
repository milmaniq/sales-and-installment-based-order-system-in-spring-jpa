    ...
    void initVariable(String orderId, ManageOrderController manageOrderControllerAddress) {
        ...
        try {
            ...
            if (orderDTO.getDateOfOrder() == null) {
                ...
                dateDateOfOrder.setValue(((java.sql.Date)orderDTO.getDateOfOrder()).toLocalDate());
            }

            if (orderDTO.getDateOfDelivery() == null) {
                dateDateOfDelivery.setValue(null);
            } else {
                dateDateOfDelivery.setValue(((java.sql.Date)orderDTO.getDateOfDelivery()).toLocalDate());
            }
            ...
            if (orderDTO.getDateOfActualDelivery() != null) {
                ...
                dateDateOfActualDelivery.setValue(((java.sql.Date)orderDTO.getDateOfActualDelivery()).toLocalDate());
            }

            if (orderDTO.getDateOfCancellation() != null) {
                rbCancelled.setSelected(true);
                dateDateOfCancellation.setValue(((java.sql.Date)orderDTO.getDateOfCancellation()).toLocalDate());
            }
